...
def daily_stats(time_series):
  ...
  for epoch in time_series:
    ...
    listes[giornate.index(day_start_epoch)].append(epoch[1])
    #qui aggiungo la temperatura nella lista del giorno day_start_epoch a sua volta contenuta in listes
